...
-- Paste from system cilpboard in normal mode (no indentation)
...
-- Paste from system cilpboard in visual mode (no indentation)
...
-- Paste from system clipboard in insert mode (no indentation)
...
-- Black hole paste in visual mode (no indentation)
